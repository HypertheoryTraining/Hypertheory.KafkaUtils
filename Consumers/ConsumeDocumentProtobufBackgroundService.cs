...
public abstract class ConsumeDocumentProtobufBackgroundService<TKey, TValue> : BackgroundService
...

{
    ...
    public ConsumeDocumentProtobufBackgroundService(ConsumerConfig consumerConfig, string topic)
    {
